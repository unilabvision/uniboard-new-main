...
const texts = {
  tr: {
    ...
    howTitle: 'Kısaca',
    how1: 'İlan: sitedeki detay sayfası (banner, fırsat bilgileri, açıklama, başvur butonu) — tüm yayınlar aynı şablon.',
    how2: 'Form: /basvuru/{slug} adresindeki başvuru soruları; ilan slug’ına otomatik bağlanır.',
    how3: 'Banner yükle → “Sitede yayınla” → Kaydet. Ayrı deploy gerekmez.',
    new: 'Yeni ilan',
    loading: 'Yükleniyor...',
  ...
  en: {
    ...
    howTitle: 'In short',
    how1: 'Listing: detail page (banner, details, description, apply CTA) — one shared template for every publish.',
    how2: 'Form: questions at /application/{slug}; auto-linked to the listing slug.',
    how3: 'Upload banner → Publish on site → Save. No separate deploy per listing.',
    new: 'New listing',
    loading: 'Loading...',
