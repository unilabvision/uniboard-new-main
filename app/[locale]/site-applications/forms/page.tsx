...
const texts = {
  tr: {
    ...
    subtitle: 'Kurumunuzun iş veya gönüllü başvuru formlarını yönetin',
    newTeamForm: 'Yeni Başvuru Formu',
    newEventForm: 'Yeni Etkinlik Formu',
    tabTeam: 'Site Başvuruları',
    ...
    loading: 'Yükleniyor...',
    emptyTeam: 'Henüz başvuru formu yok. Kurumunuz için iş veya gönüllü formu oluşturabilirsiniz.',
  ...
  en: {
    ...
    subtitle: 'Manage your organization\'s job or volunteer application forms',
    newTeamForm: 'New Application Form',
    newEventForm: 'New Event Form',
    tabTeam: 'Site Applications',
    tabEvent: 'Event Applications',
    tabAll: 'All',
    superAdminOnly: 'You do not have permission to create or edit forms. Please contact your administrator.',
    loading: 'Loading...',
    emptyTeam: 'No application forms yet. Create a job or volunteer form for your organization.',
    ...
    edit: 'Edit',
    preview: 'Preview',
    teamBadge: 'Application',
    eventBadge: 'Event',
    linkedEvent: 'Linked event',
    menuPlacement: 'Publish',
    teamMenu: 'Site',
    eventMenu: 'Events',
    noLinkedEvent: '—',
  },
