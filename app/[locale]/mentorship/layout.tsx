...
import { hasMentorshipAccess } from '@/app/lib/mentorship/permissions';
...
export default function MentorshipLayout({ children, params }: MentorshipLayoutProps) {
      ...
      <div className="min-h-screen flex items-center justify-center p-8">
        <div className="max-w-md text-center">
          ...
          <p className="text-neutral-600">
            {locale === 'tr'
              ? 'Mentörlük paneline erişiminiz yok.'
              : 'You do not have access to the mentorship panel.'}
          </p>
        </div>
      </div>
    );
