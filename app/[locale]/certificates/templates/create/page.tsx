...
export default function CreateTemplatePage() {
  ...
  const [formData, setFormData] = useState<TemplateFormData>({
    ...
    design_settings: {
      ...
      layout: {
        ...
        name_position: { x: 7, y: 35.5, enabled: false, align: 'left', x_manual: 7, y_manual: 37 },
        description_position: { x: 7, y: 49, enabled: false, align: 'left', x_manual: 7, y_manual: 49 },
        ...
        setFormData(prev => ({ 
          ...
          design_settings: {
            ...
            layout: {
              ...
              title_position: { ...prev.design_settings.layout.title_position, enabled: false },
              name_position: { ...prev.design_settings.layout.name_position, enabled: false },
              description_position: { ...prev.design_settings.layout.description_position, enabled: false },
              institution_position: { ...prev.design_settings.layout.institution_position, enabled: false },
  ...
  // Update aspect ratio when background image URL changes (for direct URL input)
  useEffect(() => {
                ...
                <div>
                  ...
                  {!loading && organizations.length === 0 && (
                    <p className="text-sm text-yellow-600 dark:text-yellow-400 mt-2">
                      Kuruluş bulunamadı.{' '}
                      <Link href={`/${locale}/certificates/settings`} className="underline hover:text-yellow-700 dark:hover:text-yellow-300">
                        Kurum ayarlarından
                      </Link>{' '}
                      ekleyin veya erişim talep edin.
                    </p>
                  )}
                </div>
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              title_position: {
                                ...
                                enabled: !(prev.design_settings.layout.title_position.enabled !== false)
                              }
                            }
                          }
                        }))}
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              name_position: {
                                ...
                                enabled: !(prev.design_settings.layout.name_position.enabled !== false)
                              }
                            }
                          }
                        }))}
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              description_position: {
                                ...
                                enabled: !(prev.design_settings.layout.description_position.enabled !== false)
                              }
                            }
                          }
                        }))}
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              course_name_position: {
                                ...
                                enabled: !(prev.design_settings.layout.course_name_position.enabled !== false)
                              }
                            }
                          }
                        }))}
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              institution_position: {
                                ...
                                enabled: !(prev.design_settings.layout.institution_position.enabled !== false)
                              }
                            }
                          }
                        }))}
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              date_position: {
                                ...
                                enabled: !(prev.design_settings.layout.date_position.enabled !== false)
                              }
                            }
                          }
                        }))}
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              certificate_no_position: {
                                ...
                                enabled: !(prev.design_settings.layout.certificate_no_position.enabled !== false)
                              }
                            }
                          }
                        }))}
                          ...
                          design_settings: {
                            ...
                            layout: {
                              ...
                              signature_position: {
                                ...
                                enabled: !(prev.design_settings.layout.signature_position.enabled !== false)
                              }
                            }
                          }
                        }))}
